...
static const char *termcmd[] = { "st", "-f", "inconsolata:size=11", NULL };
static const char *browser[] = { "firefox", NULL };
static const char *atom[] = { "atom", NULL };
static const char *intellij[] = { "intellij-idea-ce", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_o,			 spawn,          {.v = atom } },
	...
	{ MODKEY|ShiftMask,             XK_l,      view,           {.ui = +1 } },
	{ MODKEY|ShiftMask,             XK_h,      view,           {.ui = -1 } },
  ...
  { 0,                            XF86XK_AudioMute,          spawn,  SHCMD("amixer -D pulse set Master 1+ toggle; pkill -RTMIN+10 dwmblocks") },
  ...
  { 0,                            XF86XK_KbdBrightnessUp,    spawn,  SHCMD("~/.local/bin/kbdbacklight up") },
  { 0,                            XF86XK_KbdBrightnessDown,  spawn,  SHCMD("~/.local/bin/kbdbacklight down") },
	// exit dwm
